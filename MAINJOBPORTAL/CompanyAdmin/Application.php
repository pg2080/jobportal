                                                                ...
                                                                <div class="modal-dialog">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            Interview Date :
                                                                            <input type="date" class="form-control" name="dt"  placeholder="date">
                                                                            <br>
                                                                            Interview Time :
                                                                            <div class="col-md-10 row">
                                                                                <br><select id="dateH" name="dateH" class="form-control col-md-3 mr-3"></select>
                                                                                <select id="timeM" name="timeM"  class="form-control col-md-4 mr-3"></select>
                                                                                <select id="itime" name="itime" class="form-control col-md-3">
