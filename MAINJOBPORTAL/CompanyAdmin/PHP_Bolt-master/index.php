<?php
$MERCHANT_KEY = "cD3ECA9H";
$SALT = "74koRefD6i";
$txnid= substr(hash('sha256', mt_rand() . microtime()), 0, 20);//"b728690de9f3635d5671";
$name="anil";
$email="webanilsidhu@gmail.com";
$amount=10;
$phone="9999766582";
$surl="http://localhost/PhpProject1/CompanyAdmin/success.php";
$furl="http://localhost/PhpProject1/CompanyAdmin/failure.php";
$productInfo="xyzabc";
...
<div class="main">
    ...
    <span><input type="text" id="key" name="key" placeholder="Merchant Key" value="cD3ECA9H" /></span>
    </div>
    
    <div class="dv">
    <span class="text"><label>Merchant Salt:</label></span>
    <span><input type="text" id="salt" name="salt" placeholder="Merchant Salt" value="74koRefD6i" /></span>
    </div>
