...
<?php
//print_r($_SESSION['Login']['HRInfo']);
$CompanyId = $_SESSION['Login']['LId'];
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        Department : <b><?php echo $s['DepartmentName']; ?></b>
                                    ...
                                    <table id="bootstrap-data-table" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="bootstrap-data-table_info">
                                        ...
                                        <tbody>
                                            ...
                                            <form method="get" action="">   
                                                <td class=""> <a href="ViewJob.php?jc=tr&i=<?php echo $row['JobId']; ?>"> <i class="btn btn-sm btn-danger fa fa-trash"></i></a></td>
                                            </form>
