...
<?php
$statq = "Select * from tblFeedback LEFT JOIN companyinfo ON companyinfo.LoginId = tblfeedback.LoginId  Where FeedType='co'";
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Company FeedBack</strong>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <?php while ($row = mysqli_fetch_array($result)) { ?>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="sorting_1"><?php echo $row['CompanyName'] ?></td>
