...
<html>
	...
	//});
		...
		<div id="footer"><br>
                    <input type="button" value="Back" id="back" onclick="backPage()" class="btn btn-danger">
                    <input type="button" value="Next" id="next" onclick="nextPage()" class="btn btn-danger " style="margin-right: 10px">
		</div>
		</div>
	</body>
</html>